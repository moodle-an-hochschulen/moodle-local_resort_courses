...
if ($hassiteconfig) {
    ...
    if ($ADMIN->fulltree) {
        ...
        $page->add(new admin_setting_heading(
            'local_resort_courses/sortorderheading',
        ...
        $page->add(new admin_setting_configselect(
            'local_resort_courses/sortorder',
            get_string('sortorder', 'local_resort_courses', null, true),
        ...
        // Skip categories.
        $page->add(new admin_setting_heading(
            'local_resort_courses/skipcategoriesheading',
        ...
        $page->add(new admin_setting_configmultiselect(
            'local_resort_courses/skipcategories',
            get_string('skipcategories', 'local_resort_courses', null, true),
        ...
        $page->add(new admin_setting_configcheckbox(
            'local_resort_courses/skipcategoriesrecursively',
