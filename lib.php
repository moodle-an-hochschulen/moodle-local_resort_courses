...
define('SORT_FULLNAME_ASC', 1);
define('SORT_FULLNAME_DESC', 2);
define('SORT_SHORTNAME_ASC', 3);
define('SORT_SHORTNAME_DESC', 4);
define('SORT_COURSEID_ASC', 5);
define('SORT_COURSEID_DESC', 6);
define('SORT_STARTDATE_ASC', 7);
define('SORT_STARTDATE_DESC', 8);
...
function resort_courses($eventdata) {
	...
	// Resort category - borrowed from /course/category.php line 61
